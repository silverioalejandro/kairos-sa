                ...
                <v-row class="pb-0 pt-2">
                    ...
                    <v-col class="py-0">
                        <v-text-field
                            ...
                            label="Dni Cliente."
                            clearable
                            v-model.trim="filters.identification_number"
                        ></v-text-field>
                    </v-col>
                    ...
                    <v-col class="py-0">
                        <v-autocomplete
                            ...
                            v-model="filters.status_product_code"
                        ></v-autocomplete>
                    </v-col>
                </v-row>
            </template>
...
export default {
    ...
    data: () => ({
        panel: [0],
        multipleSelectionFields:["id", "identification_number"],
        filters: {
            id: null,
            identification_number: null,
            category_code: null,
            status_product_code: null,
        }
    }),
    computed: {
